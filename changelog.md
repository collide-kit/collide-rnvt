...
The first stable release of **@collide-kit/collide-rntv** — a shareable [Renovate](https://docs.renovatebot.com/) configuration preset for the **@collide-kit** ecosystem.
